/*	1.	Copy the order by exercise and save it as functions_exercises.sql.
        ...
        */
		USE employees;
/*	2.	Write a query to to find 
			all employees whose 
			last name starts and ends with 'E'. 
		Use concat() to combine their 
        first and last name together as 
        a single column named full_name.
        */
...
/*	4.	Find all employees hired in the 90s and born on Christmas. 
        ...
        */
        SELECT 	CONCAT(first_name, ' ', last_name) AS Employee, 
				CONCAT('Working for ', DATEDIFF(CURDATE(), hire_date), ' days!!') AS 'Length Working' 
		FROM employees
        WHERE 	hire_date
