...
/*	2.	MySQL provides a way to return 
		only unique results from our queries with the keyword DISTINCT. 
...
/*	3.	Find all previous or current employees 
		hired in the 90s and born on Christmas. 
        Find the first 5 employees hired in the 90's by 
        sorting by hire date and limiting your results to the first 5 records. 
...
/*	4.	Try to think of your results as batches, sets, or pages. 
        ...
        What is the relationship between 
			...
			LIMIT (number of results per page), and 
			the page number?
		*/
		SELECT * FROM employees
        WHERE 	hire_date
